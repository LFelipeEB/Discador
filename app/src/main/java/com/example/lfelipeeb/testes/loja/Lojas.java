...
public class Lojas implements Serializable{
    ...
    public static List<Lojas> getLojas(){
        ...
        lojas.add(new Lojas("FOGÃO DE LENHA", R.drawable.restaurante, null, "10:00-23:59", "0,1,2,3,4,5,6", "RUA ANTÔNIO TEODOLINO 35 B. MARIA LUCIA Capelinha - MINAS GERAIS", "35163823", "91282191 ", null, "88156980", null, null));
        lojas.add(new Lojas("BIG BURGUER", R.drawable.food, null, "18:00-23:59", "0,1,2,3,4,5,6", "Rua Tamboril 400 Mª Lucia, Capelinha - MINAS GERAIS", null, "91041843 ", null, "88956527", null, null));
        ...
        lojas.add(new Lojas("CASA DO HAMBÚRGUER",R.drawable.food,null,null,null,"Av Aeroporto 370 Jardim Aeroporto, Capelinha - MINAS GERAIS",null,"91412996",null,"87305011",null,null));
        ...
        lojas.add(new Lojas("SHREK BURGUER",R.drawable.food,null,null,null,null,null,null,"91150369",null,null,null));
        lojas.add(new Lojas("STORIL PIZZARIA E RESTAURANTE",R.drawable.restaurante,null,null,null,"Rua Carlos Prates 196 Mª Lucia, Capelinha - Minas Gerais","35161751",null,"91617172",null,null,null));
        lojas.add(new Lojas("ZAGA FARMA",R.drawable.ambulance,null,null,null,"Capelinha","35161579",null,null,null,null,null));
